 ...
 * @author Infi
 */
public interface LookupNumberDao {
    /**
     * 新增验证通过的电话号码
     *
     * @param number      电话号码
     ...
     */
    void addNumber(@Param("number") String number, @Param("createTime") Date createTime, @Param("type") String type,
                   @Param("carrierName") String carrierName, @Param("countryCode") String countryCode);
     ...
     * @return 验证通过的电话号码
     */
    LookupNumber findNumber(@Param("number") String number);
}
